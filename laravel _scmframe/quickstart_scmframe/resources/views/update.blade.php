...
@section('content')
<form action="{{ url('task/' . $post->id  . '/updatequery') }}" method="GET" class="form-horizontal" style="width:400px; height:100px !important; margin:0 auto; border:1px solid; padding:10px">
            {{ csrf_field() }}
